...
Dossier réservé. Le projet Spring Boot sera initialisé par #5 et #6 ; les versions de Java, Spring Boot et Maven seront figées à ce moment-là, après vérification. À compléter alors : commandes, structure des modules, conventions d'API et de tests.
